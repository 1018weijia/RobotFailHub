...
| [PRIMO-R1](datasets/PRIMO-R1.md) | 2026-03 | Process reasoning critic；116k SFT + 182k RL；23.7k bench | Robot / Real + Sim | video + init/current frame + CoT progress | Bench 23.7k；媒体 ~78 GB | 有（1–100 + CoT） | 有（失败检测 + real-humanoid OOD） | 待核验 | 无 | [HF Collection](https://huggingface.co/collections/LeonOverload/primo-r1) · [Bench JSON](https://huggingface.co/datasets/LeonOverload/primo-bench-json) |
