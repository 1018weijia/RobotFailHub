...
| [DenseReward](datasets/DenseReward.md) | 2026-07 | 27k 操作 episode、756 万帧级 dense reward；含物理失败合成 | Robot+Human / Sim+Real | video + language + dense reward | 待核验（~27k episodes） | 有（帧级 0–1 progress） | 有（collision/miss/fall/recover 等） | 有（Reach/Grasp/Lift/Move/Place 五阶段） | 有（failure mode 标注） | [Project](https://dense-reward.github.io/) · [Models HF](https://huggingface.co/densereward) |
